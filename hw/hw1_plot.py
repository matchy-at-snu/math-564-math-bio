...
def plot_closed_form(r1, r2, a1=1, a2=1, n=10, name='default.pdf'):
    """
    ...
    if (r1 == r2):
        ...
        plt.ylabel(rf"$x_n = ({a1} + {a2} n) ({r1})^n$")
    else:
...
def plot_complex_value(a, b, name='default.pdf'):
    """
    ...
    fig.add_axes(ax)
    ax.scatter(x, y, zorder=4, color="red")
    for z in cnums:
        ax.text(
            z.real+0.1*x_intr,
            z.imag+-0.3*y_intr,
...
if __name__ == "__main__":
    ...
    # ------------------------------------------------------- #
    plot_closed_form(1, 1, name='fig3(b)(ii).pdf')
    plot_closed_form(-1, -1, name='fig3(b)(iii).pdf')
    # ------------------------------------------------------- #
